...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-sm-5 bg-white p-sm-4">
            <h4>Daftar</h4>
            <small>Silahkan lengkapi form yang disediakan untu membuat akun anda. atau kembali ke <a
                    href="index.php">Beranda</a> </small>
            <?php
                if (@$_POST):
                    include './koneksi/koneksi.php';
                    $nama=$_POST['nama'];
                    ...
                    elseif($pass !== $konfir){
                        ...
                        $result=$conn->query("SELECT * FROM 18132_user WHERE username='$user'");
                        if ($result->num_rows == 0) {
                            if ($conn->query("INSERT INTO 18132_user VALUES(null, '$nama', '$telp', '$alamat', '$user', MD5('$pass'), 'penyewa')")){
            ...
            <form class="my-2" method="post">
                ...
                <button type="submit" class="btn text-white btn-block bg-dark">Daftar</button>
            </form>
