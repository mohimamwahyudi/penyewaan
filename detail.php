        ...
        <div class="col p-sm-4">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    <?php
                    $id=@$_GET['id'];
                    $result = $conn->query("SELECT a.jumlah jml, b.*, (b.harga_sewa*a.jumlah) total FROM 18132_d_sewa a, 18132_alat b WHERE a.id_mobil=b.id_mobil AND a.id_sewa='$id'") or die($conn->error);
